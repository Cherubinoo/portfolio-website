...
import { Mail, MapPin, Phone, Linkedin, Github, Instagram, Download, FileText } from "lucide-react";
            ...
            <div className="space-y-8">
              ...
              <Card className="border-0 shadow-elegant bg-card/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Get a copy of my detailed resume with my experience and skills.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Button
                    ...
                    className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-nature hover:shadow-warm transition-all duration-300 flex items-center gap-2"
                  >
